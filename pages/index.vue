  ...
  <NuxtLayout name="default">
    <div class="">
      <div class="flex items-center gap-5 p-5 border-b border-gray-800">
        <UInput v-model="value" size="sm" placeholder="Search..." icon="i-heroicons-magnifying-glass" class="grow"
          color="gray" />
        <UButton icon="i-heroicons-magnifying-glass" color="primary" variant="solid" label="Search" :trailing="false"
          to="/" size="sm" />
      </div>
      <div class="">
        <div class="">
          <div class="">
            <a v-for="product in productPage" :href="product.url" target="_blank"
